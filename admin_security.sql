...
-- Drops any existing conflicting policies first to prevent 42710 errors,
-- then grants public INSERT permissions for form submissions.
-- ==========================================================
...
-- 2. Applications Policies (Public insert, authenticated read/write/delete)
...
CREATE POLICY "apps_public_insert" ON applications FOR INSERT TO public WITH CHECK (true);
...
-- 3. Enterprise Leads Policies (Public insert, authenticated read/write/delete)
...
CREATE POLICY "leads_public_insert" ON enterprise_leads FOR INSERT TO public WITH CHECK (true);
...
-- 4. Enterprise Applications Policies (Public insert, authenticated read/write/delete)
...
CREATE POLICY "ent_apps_public_insert" ON enterprise_applications FOR INSERT TO public WITH CHECK (true);
...
-- 5. Contact Inquiries Policies (Public insert, authenticated read/delete)
...
CREATE POLICY "inquiries_public_insert" ON contact_inquiries FOR INSERT TO public WITH CHECK (true);
