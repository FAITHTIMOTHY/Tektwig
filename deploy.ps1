...
$filesToUpload = @(
    ...
    @{ local = "admin/login.html"; remote = "$remoteDir/admin/login.html" },
    @{ local = "admin/login.js"; remote = "$remoteDir/admin/login.js" },
    @{ local = "admin/auth.php"; remote = "$remoteDir/admin/auth.php" },
