...
document.addEventListener('DOMContentLoaded', () => {
      ...
      <div class="job-card glass-panel${job.isThirdParty ? ' job-card--external' : ''}" id="job-card-${job.id}" style="cursor: pointer;">
        ...
        <div class="job-meta-info">
          ...
          <div class="job-meta-item">
            ...
            <span>${escapeHTML((job.experience && job.experience.trim()) || 'Any Experience')}</span>
          </div>
        </div>
  ...
  async function openApplyModal(jobId, showForm = true) {
    try {
      ...
      modalJobExp.textContent = (selectedJob.experience && selectedJob.experience.trim()) || 'Any Experience';
